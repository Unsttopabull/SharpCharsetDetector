...
namespace Frost.SharpCharsetDetector {
    ...
    public static class Charsets {
        ...
        /// <summary>East-Europe. Disabled because too similar to windows-1252 (latin-1). Should use tri-grams models to discriminate between these two charsets.</summary>

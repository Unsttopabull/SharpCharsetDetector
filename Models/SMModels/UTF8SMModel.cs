...
namespace Frost.SharpCharsetDetector.Models.SMModels {
    ...
    public class UTF8SMModel : SMModel {
        ...
        public UTF8SMModel() : base(
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, UTF8Cls),
            16,
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, UTF8St),
            UTF8CharLenTable,
            "UTF-8",
            65001) {
        }

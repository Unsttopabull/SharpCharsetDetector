...
namespace Frost.SharpCharsetDetector.Models.SMModels {
    ...
    public class HzSMModel : SMModel {
        ...
        public HzSMModel() : base(
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, HzCls),
            6,
            new BitPackage(IndexShift.Shift4BITS, ShiftMask.Mask4BITS, BitShift.Shift4BITS, UnitMask.Mask4BITS, HzSt),
            HzCharLenTable,
            "HZ-GB-2312",
            52936) {
        }

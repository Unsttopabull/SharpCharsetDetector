...
namespace Frost.SharpCharsetDetector.Models {
    ...
    /// <summary>State machine model</summary>
    public abstract class SMModel {
        ...
        public readonly BitPackage ClassTable;
        public readonly BitPackage StateTable;

        protected SMModel(BitPackage classTable, int classFactor, BitPackage stateTable, int[] charLenTable, string name, int winCodePage) {
        ...
        public int ClassFactor { get; private set; }

...
namespace Frost.SharpCharsetDetector.Probers {
    ...
    public enum ProbingState {
        ///<summary>No sure answer yet, but caller can ask for confidence</summary>
        Detecting = 0, 
    ...
    public abstract class CharsetProber {
        ...
        /// <summary>Feed data to the prober</summary>
        ...
        /// <summary>Reset prober state</summary>
        ...
        /// <summary>Helper functions used in the Latin1 and Group probers</summary>

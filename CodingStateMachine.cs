...
namespace Frost.SharpCharsetDetector {
    ...
    /// <summary>Parallel state machine for the Coding Scheme Method</summary>
    public class CodingStateMachine {
        ...
        public int CurrentCharLen { get { return _currentCharLen; } }

        public string ModelName { get { return _model.Name; } }

        public int CodePage {get { return _model.WindowsCodePage; }}
